---
title: 'Quickstart'
description: 'Running ChronoLog on a single node docker images.'
icon: 'code'
---
...
Now that you’ve got ChronoLog installed and deployed, it’s time to explore its capabilities with the **Interactive Client Admin**. 
This tool lets you interact with the ChronoLog system in real time, and it’s perfect for getting hands-on experience.
...
Once you’ve finished working with a Story, release it. Story needs to be released for peaceful and safety close. To do so:
```bash
...
If you no longer need a Story or Chronicle, you can delete them. You can remove them by detroying them:
- To destroy a Story:
  ```bash
...
#### What’s Next?
Now that you’ve set up ChronoLog, you’re all set to explore its powerful features. 
Keep an eye out for our next tutorial, where we’ll guide you through running your first ChronoLog application and uncovering the magic it can bring to your data workflows.
